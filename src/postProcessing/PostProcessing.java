...
public class PostProcessing {
	...
	private static BrightFilter brightFiler;
	...
	public static void init(Loader loader){
		...
		brightFiler = new BrightFilter(Display.getWidth() / 2, Display.getHeight() / 2);
